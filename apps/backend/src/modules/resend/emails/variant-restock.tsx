        ...
        <Body
          ...
          <Container className="p-6">
            ...
            <Text className="text-center mt-2" style={{ color: '#57534E' }}>
              The record you wanted is back — grab it before it's gone
              again.
            </Text>
          </Container>
...
const variantRestockEmail = (props: VariantRestockEmailProps) => (
